...
SELECT * FROM ((SELECT FirstName, LastName, MajorSchools, Grade, Email, Interview_Deliberate, -1 FROM $rushTable WHERE Interview_Wave = 0) UNION (SELECT * FROM (SELECT FirstName, LastName, MajorSchools, Grade, Email, Interview_Deliberate, @rank:=@rank+1 as 'a' FROM $rushTable WHERE Interview_Wave > 0 ORDER BY Interview_Wave, LastName) as T1 WHERE Interview_Deliberate = 1)) AS a");
